...
with DAG(
    ...
    start_date=dt.datetime(2020, 10, 17) - None.None(None=None),
    ### END CODE HERE ###
    ...
    def get_session_info_dict(date: str):
        ...
        session_info_string = None[None].None()
        ### END CODE HERE ###
    ...
    # DAG:
    start_task >> [get_new_users_task, None]
    None >> None >> None
    [None, None] >> None
    None >> None
    ### END CODE HERE ###
